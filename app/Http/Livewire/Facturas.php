...
class Facturas extends Component
{
	...
	public function servicios_operador($id,$name){
		...
		$this->myservicios  = DB::table('facturas')
			...
			->select('facturas.placa', 'services.porcentaje' ,'carstypes.name as cars','services.name as servicio', 'facturas.value', 'facturas.empresa','facturas.operario','facturas.fecha','facturas.operario_id')
