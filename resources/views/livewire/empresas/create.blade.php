        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
            ...
            <div class="form-group d-none">
                ...
                <input wire:model.defer="users_id" type="text" class="form-control" id="users_id" placeholder="Users Id">@error('users_id') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
